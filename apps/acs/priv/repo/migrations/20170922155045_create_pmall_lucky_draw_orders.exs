defmodule Acs.Repo.Migrations.CreatePmallLuckyDrawOrders do
  ...
  def change do
    create table(:pmall_lucky_draw_orders) do
      ...
      add :wcs_user_id, references(:wcs_users, on_delete: :nothing)
    ...
    create index(:pmall_lucky_draw_orders, [:app_id, :wcs_user_id])
    create index(:pmall_lucky_draw_orders, [:app_id, :wcs_user_id, :lucky_draw_id])
