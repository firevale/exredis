defmodule Acs.PointMallOrder do
  use Acs.Web, :model
...
@primary_key false
  schema "point_mall_orders" do
    ...
    has_many :goods, Acs.PointMallGoods, references: :id
  ...
  def init_mapping() do
    unless Elasticsearch.is_type?("pointMall", "orders") do
      mapping = %{
        properties: %{
          id: %{type: :keyword},
      ...
      Elasticsearch.put_mapping(%{index: "pointMall", type: "orders", mapping: mapping, params: nil})
    end
  end
end
