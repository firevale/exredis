defmodule ElasticSearch do
  ...
  #   :poolboy.transaction :elasticsearch, fn(worker) ->
  #     index(worker, index, type, doc, id, params)
  #   end   
  # end
  # defp index(worker, index, type, doc, nil, params) do  
  #   ElasticSearch.Worker.request %{worker: worker, 
  #                                  method: :post, 
  #                                  path: [index, type], 
  #                                  body: doc,
  #                                  params: params}
  # end
  # defp index(worker, index, type, doc, id, params) do  
  #   ElasticSearch.Worker.request %{worker: worker, 
  #                                  method: :put, 
  #                                  path: [index, type, id], 
  #                                  body: doc,
  ...
  #   :poolboy.transaction :elasticsearch, fn(worker) ->
  #     update(worker, index, type, doc, id, params)
  #   end   
  # end
  # defp update(worker, index, type, doc, id, params) do 
  #   ElasticSearch.Worker.request %{worker: worker, 
  #                                  method: :post, 
  ...
  #   end   
  # end
  # defp delete(worker, index, type, id, params) do 
  #   ElasticSearch.Worker.request %{worker: worker, 
  #                                  method: :delete, 
  #                                  path: [index, type, id], 
  #                                  params: params}    
  ...
  #   end   
  # end
  # defp count(worker, index, type, query, params) do 
  #   path = case type do 
  #           nil -> 
  #             [index, "_count"]
  #           "" -> 
