defmodule Exmail.Emails do 
  import Bamboo.Email
  use    Bamboo.Phoenix, view: Exmail.EmailView
  ...
  defp base_email(locale) do
    Gettext.put_locale(Exmail.Gettext, locale)

    new_email()
    |> put_html_layout({Exmail.LayoutView, "email.html"})
  end
end