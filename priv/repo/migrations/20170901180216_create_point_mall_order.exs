defmodule Acs.Repo.Migrations.CreatePointMallOrder do
  use Ecto.Migration

  def change do
    create table(:point_mall_orders, primary_key: false) do
    ...
    create index(:point_mall_orders, [:user_id])
    create index(:point_mall_orders, [:user_id, :status])
    create index(:point_mall_orders, [:transaction_id], unique: true)
