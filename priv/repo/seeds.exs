...
Acs.Repo.all(App) |> Enum.each(fn(app) -> 
  app |> App.changeset(%{payment_callback: "http://127.0.0.1:4000/api/sdkpay/default_callback",
  has_mall: false, has_forum: false, restrict_login: false}) |> Acs.Repo.update!
end)

Acs.Repo.insert(%Acs.Accounts.User{
  id: 100001, 
  email: "xiaobin@firevale.com", 
  encrypted_password: "$pbkdf2-sha512$160000$ofJOLH.3vbHuma7t/DGQmQ$0wRciGKFbmyb6U077Flruk/LStLBa167Q5ejgZNXYxeEIquCTPfYr0AkapEQNWVOjtJ5rTu9n2bWJyLKXJsnKw", 
  nickname: "逍遥", 
  gender: "male", 
  age: 1})
Acs.Repo.insert(%Acs.Accounts.User{id: 100002, email: "zhongxiaobin@firevale.com", encrypted_password: "$pbkdf2-sha512$160000$XBC9izsPHnce3kqllIpE8A$xh0TY1uYF3VKukY5fwyqsGEkLqvY.o.iIdaN536i2lSJp6Bnu4xNsu/FH243xuEv9UrLQXLOPmPetmi3hrmdmA", nickname: "zhongxiaobin", gender: "male", age: 1}) 
Acs.Repo.insert(%Acs.Accounts.User{id: 100003, email: "zhumingzhen@firevale.com", encrypted_password: "$pbkdf2-sha512$160000$c4oGViAQf4ANOPDYAjAnTg$KCikauke6I4K7BSB3Iy9KYwTrFxwaAIdLIv.p.eUsEy62fiIuPYcm4ZT14X5wNToFPpidVeW4oPfTWfTBz9MPw", nickname: "zhumingzhen", gender: "male", age: 1})
Acs.Repo.insert(%Acs.Accounts.User{id: 100004, email: "xiebing@firevale.com", encrypted_password: "$pbkdf2-sha512$160000$iH9w/vVpiR58wgv379WaOg$nS5OABJHfBOXXYjuSnXwhJXMaDdqnwE0vIQmPLFBCsWCxNgr02kfQ3PGSwx6tBCnsDQmluh/rB8zCMkxgcarwg", nickname: "流年", gender: "male", age: 18}) 

Acs.Admin.AdminUser.changeset(%Acs.Admin.AdminUser{}, %{account_id: "xiaobin@firevale.com", user_id: 100001, admin_level: 1}) |> Acs.Repo.insert
