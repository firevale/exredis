...
export default {
  ...
  titles: {
    ...
    cancel: '取消',
    warning: '警告',
    searchAppOrders: '输入用户ID、手机号、电子邮箱、订单号、商品ID, 游戏用户ID, sdk用户ID查询',
    searchMallOrders: '输入用户ID/订单号/用户姓名/手机号搜索',
    searchGoods: '搜索商品名称',
    searchUsers:'输入用户ID、昵称、手机号码、邮件地址、身份证号码、实名、游戏ID、角色名查询',
    searchWcsUsers:'输入微信昵称、openid、平台用户id，积分兑换地址、电话、姓名查询',
