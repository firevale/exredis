  ...
  <div class="tile box is-ancestor is-vertical" style="padding: 10px; margin: 0">
    <div class="tile is-parent border-horizontal" style="padding: 0 0 10px 0">
      <div class="tile is-child is-3">
        <file-upload class="file-upload" ref="upload" name="file" :drop="true" :multiple="true" :post-action="params.action"
          :accept="params.accept" :extensions="params.extensions" :header="params.headers" @addFileUpload="addFileUpload"
          @afterFileUpload="afterFileUpload"></file-upload>
      </div>
