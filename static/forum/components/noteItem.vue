...
<div class="note-item">
  ...
  <div class="columns">
    <div class="column is-10">
      <span class="author-name">{{itemData.user.nickname}}</span>
    </div>
...
export default {
  ...
  computed: {
    ...
    filterKey() {
      return this.searchModel ? this.itemData.title.replace(new RegExp(this.searchKey, 'g'),
        '<span class="red">' + this.searchKey +
