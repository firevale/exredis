...
<div class="post-list-item">
  <div class="columns">
    ...
    <div class="column is-2 txt-right note-info">{{postInfo.last_reply_at | formatServerDateTime}}</div>
  </div>
  <div class="columns">
    <div class="column is-10">
      <span class="author-name">{{postInfo.user.nickname}}</span>
    </div>
    <div class="column is-2 txt-right note-info">{{postInfo.comms}}/{{postInfo.reads}}</div>
  </div>
</div>
</template>
