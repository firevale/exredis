<template>
  <div class="search-page card">
    <div class="card-content">
      <div class="search-bar" :class="postList && postList.length > 0 ? 'has-bottom-line' : ''">
        <div class="field is-grouped">
          <p class="control is-expanded">
            <input type="input" class="input is-primary" v-model.trim="keyword" @keydown.enter="search" @keydown.esc="keyword = ''"
              :placeholder="$t('forum.search.placeholder')">
            </input>
          </p>
          <p class="control">
            <a class="button is-primary" @click.prevent="search">搜索贴子</a>
          </p>
        </div>
      </div>
      <p v-if="searchTip">
      ...
      <div class="has-text-centered" style="width: 100%">
        <span v-show="!postList && searchKeywordHistory.length" class="is-primary is-clickable" @click="clearSearchHistory">
