  ...
  return {
    ...
    methods: {
      ...
      unregister: function unregister (name) {
        ...
        if(this._validityWatchers[name]){
...
var Helper = function (Vue) {
  ...
  return {
    ...
    modelValueEqual: modelValueEqual
  }
};
...
var SingleElementClass = function (Vue) {
  var ref = Vue.util;
  var looseEqual = ref.looseEqual;
  var ref$1 = Helper(Vue);
  var addEventInfo = ref$1.addEventInfo;
  var modelValueEqual = ref$1.modelValueEqual;
...
var ComponentElementClass = function (Vue) {
  ...
  var ComponentElement = function ComponentElement (vm, vnode) {
  ...
  ComponentElement.prototype.fireInputableEvent = function fireInputableEvent () {
    var args = { value: this.getValue() };
    args[MODEL_NOTIFY_EVENT] = 'COMPONENT';
    this._vnode.child.$emit('input', args);
  };

  ComponentElement.prototype.modelValueEqual = function modelValueEqual$1 (vnode) {
    return modelValueEqual(vnode)
  };
