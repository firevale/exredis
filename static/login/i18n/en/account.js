export default {
  loginPage: {
    ...
    accountIdPlaceholder: 'Please input your account',
    userMobilePlaceholder: 'Please input your mobile phone number',
    userEmailPlaceholder: 'Please input your email address',
