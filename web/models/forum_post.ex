defmodule Acs.ForumPost do
  ...
  def changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:title, :content, :is_top, :is_hot, :is_vote, :created_at, :last_reply_at])
    |> validate_required([:title, :content, :is_top, :is_hot, :is_vote, :created_at, :last_reply_at])
